...
table_config = [  # 配置文件
    ...
    },
    {
        ...
        'attrs': {'k1': 'v1', 'origin': '@device_type_id', 'edit-enable': 'true',
                  'edit-type': 'select', 'global_key': 'device_type_choices', 'name': 'device_type_id'}
    },
    {
        'q': 'device_status_id',
        'title': '状态',
        ...
        'attrs': {'edit-enable': 'true', 'origin': '@device_status_id', 'edit-type': 'select',
                  'global_key': 'device_status_choices', 'name': 'device_status_id'}
    },
    {
        'q': 'cabinet_num',
        'title': '机柜号',
    ...
    },
    {
        ...
        'attrs': {'name': 'idc_id', 'k1': 'v1', 'origin': '@idc_id', 'edit-enable': 'true', 'edit-type': 'select',
