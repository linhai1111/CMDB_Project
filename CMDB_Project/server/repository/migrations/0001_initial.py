# Generated by Django 2.0.2 on 2018-04-09 15:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(auto_now_add=True)),
                ('asset_obj', models.ForeignKey(on_delete='', related_name='ar', to='repository.Asset')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_at', models.DateTimeField(auto_now_add=True)),
                ('asset_obj', models.ForeignKey(blank=True, null=True, on_delete='', to='repository.Asset')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('asset', models.OneToOneField(on_delete='', to='repository.Asset')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='nic',
            name='server_obj',
            field=models.ForeignKey(on_delete='', related_name='nic', to='repository.Server'),
        ),
        migrations.AddField(
            model_name='memory',
            name='server_obj',
            field=models.ForeignKey(on_delete='', related_name='memory', to='repository.Server'),
        ),
        migrations.AddField(
            model_name='disk',
            name='server_obj',
            field=models.ForeignKey(on_delete='', related_name='disk', to='repository.Server'),
        ),
        migrations.AddField(
            model_name='businessunit',
            name='contact',
            field=models.ForeignKey(on_delete='', related_name='c', to='repository.UserGroup', verbose_name='业务联系人'),
        ),
        migrations.AddField(
            model_name='businessunit',
            name='manager',
            field=models.ForeignKey(on_delete='', related_name='m', to='repository.UserGroup', verbose_name='系统管理员'),
        ),
        migrations.AddField(
            model_name='assetrecord',
            name='creator',
            field=models.ForeignKey(blank=True, null=True, on_delete='', to='repository.UserProfile'),
        ),
        migrations.AddField(
            model_name='asset',
            name='business_unit',
            field=models.ForeignKey(blank=True, null=True, on_delete='', to='repository.BusinessUnit', verbose_name='属于的业务线'),
        ),
        migrations.AddField(
            model_name='asset',
            name='idc',
            field=models.ForeignKey(blank=True, null=True, on_delete='', to='repository.IDC', verbose_name='IDC机房'),
        ),
        migrations.AddField(
            model_name='asset',
            name='tag',
        ...
        migrations.AddField(
            ...
            name='user_info',
            field=models.OneToOneField(on_delete='', to='repository.UserProfile'),
        ),
    ]
